      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="space-y-4">
          ...
          <StatCard
            ...
            label="Open Events"
            value={openProjects}
            sublabel="Volunteers still needed"
          />
          <StatCard
            icon={<TrendingUp />}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
          <StatCard
            ...
            value={membersInGrowth}
            sublabel={`${Math.round((membersInGrowth / totalMembers) * 100)}% of members`}
          />
          <StatCard
            icon={<Activity />}
            label="Active Volunteers"
            value={activeVolunteers}
            sublabel={`${Math.round((activeVolunteers / totalMembers) * 100)}% of members`}
          />
          <StatCard
            icon={<TrendingUp />}
            label="Service Hours"
